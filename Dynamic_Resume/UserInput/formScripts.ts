...
const skill1 = document.getElementById('skills1') as HTMLInputElement;
const skill2 = document.getElementById('skills2') as HTMLInputElement;
const skill3 = document.getElementById('skills3') as HTMLInputElement;
